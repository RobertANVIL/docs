...
Configuration for API settings. Learn more about API pages at [API Components](/api-reference/endpoint/get).
  <Expandable title="API">
    ...
    <ResponseField name="playground" type="Playground">
      ...
      <Expandable title="Playground">
        ...
        Learn more at the [playground guides](/api-reference/endpoint/get)
        </ResponseField>
      </Expandable>
    </ResponseField>
